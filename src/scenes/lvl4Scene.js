...
export default class Lvl4Scene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('lvl4bg', 'assets/images/Levels/LVL4/Lvl 4.jpg');
    ...
    create(){
        ...
        this.physics.world.setBounds((this.game.canvas.width - 982) / 2, 0, 982, 1026, true, true, true, true);
        this.cameras.main.setBounds(0, 0, 982, 1026);
        this.cameras.main.setSize(this.game.canvas.width,this.game.canvas.height);
        this.cameras.main.setZoom(this.game.canvas.height/1026) //2

        this.guernica = this.make.image({
            x: (this.game.canvas.width - 982) / 2,
            y: 0,
            key: 'lvl4bg',
            add: true
        }).setOrigin(0);
