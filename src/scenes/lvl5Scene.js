...
export default class Lvl5Scene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('lvl5bg', 'assets/images/Levels/LVL5/Lvl 5.jpg');
    ...
    create(){
        ...
        this.physics.world.setBounds((this.game.canvas.width - 836) / 2, 0, 836, 1029, true, true, true, true);
        this.cameras.main.setBounds(0, 0, 836, 1029);
        this.cameras.main.setSize(this.game.canvas.width,this.game.canvas.height);
        this.cameras.main.setZoom(this.game.canvas.height/1029) //2

        this.guernica = this.make.image({
            x: (this.game.canvas.width - 836) / 2,
            y: 0,
            key: 'lvl5bg',
            add: true
        }).setOrigin(0);
